...
export const reviews = [
    ...
    },
    {
        name: "Lavanya",
        username: "@lavanya",
        body: "This website is a game-changer, love the user experience.",
    },
    {
        name: "Geetika",
        username: "@geetika",
        body: "I'm blown away by the features and content on this site, amazing work.",
    },
    {
        name: "Ravinder",
        username: "@ravi",
        body: "The information and resources on this website are invaluable, thanks for creating it.",
    },
];